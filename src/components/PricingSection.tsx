  ...
  const hourlyPlans = [
    {
      ...
      features: [
        "Ideal for quick one-way rides",
        "Pay-as-you-go",
        "Encourages high turnaround & short trips",
      ],
      popular: false,
    ...
    },
    {
      ...
      features: [
        ...
        "Best for short errands or flexible class breaks",
        "Priority booking",
        "Useful for back-to-back short rides",
        "Free cancellations",
      ],
      popular: true,
    ...
    },
    {
      ...
      features: [
        "Unlimited rides for 24hrs",
        "Multiple rides allowed with full access",
        "Exclusive cycle stations access",
        "Monthly maintenance check",
        "Perfect for occasional full-day users",
      ],
      popular: false,
      buttonText: "Choose Plan",
      buttonVariant: "outline" as const,
  ...
  const monthlyPlans = [
    {
      ...
      description: "For regular campus travelers",
      features: [
        "Unlimited rides for whole month",
        "Monthly maintenance check",
    ...
    },
    {
      ...
      features: [
        ...
        "Exclusive cycle stations access",
        "Reserved access to cycles during peak hours",
        "Monthly maintenance check",
        "Cycle accessories included",
      ],
      popular: false,
